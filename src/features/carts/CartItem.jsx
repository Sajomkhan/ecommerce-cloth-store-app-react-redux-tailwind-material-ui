...
const CartItem = ({ item: { id, img, title, desc, price, cartQuantity } }) => {
  
  const dispatch = useDispatch();

  const onRemoveItem = () => {
    dispatch(setRemoveItemFromCart({ id, img, title, desc, price, cartQuantity }))
  }

  const onIncreaseItemQTY = () => {
    dispatch(setIncreaseItemQTY({ id, img, title, desc, price, cartQuantity }))
  }
  const onDecreaseItemQTY = () => {
    dispatch(setDecreaseItemQTY({ id, img, title, desc, price, cartQuantity }))
  }
