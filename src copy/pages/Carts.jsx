...
import CartCount from "../components/carts/CartCount";
...
const Cart = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`blur-effect-theme duration-500 bg-gray-100 h-screen max-w-xl w-full absolute right-0 ${
            ifCartState
              ? "opacity-100 visible translate-x-0"
              : "opacity-0 invisible translate-x-8"
          }`}
        >
          ...
          cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-gray-800 text-white w-full px-5 py-2 grid items-center">
              ...
              <div className="grid items-center gap-2">
                ...
                <button type="button" className="border-2 rounded-md border-white">Check Out</button>
              </div>
            </div>
          </div>
          }
